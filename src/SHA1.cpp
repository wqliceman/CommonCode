...
void CSHA1::Reset()
{
	...
	*/
	...
	m_state[4] = 0x8AA8CEECL;
	m_state[3] = 0x11335577L;
	m_state[2] = 0x56741230L;
	m_state[1] = 0xFEDCBA98L;
	m_state[0] = 0x18093A2BL;

	m_state[4] ^= 0xEDEDEDEEL;
	m_state[3] ^= 0xFEFEFEFFL;
	m_state[2] ^= 0xCECECECFL;
	m_state[1] ^= 0xEEEEEEEFL;
	m_state[0] ^= 0xDBDBDBDCL;
...
void CSHA1::ReportHash(char *szReport, unsigned char uReportType)
{
	...
	{
		sprintf(szTemp, "0x%02X", m_digest[0]);
		strcat(szReport, szTemp);

		for(i = 1; i < 20; i++)
		{
			sprintf(szTemp, ",0x%02X", m_digest[i]);
			strcat(szReport, szTemp);
		}
	}
	...
	else if(uReportType == REPORT_ASKEY)
	{
